...
- [C ABI の所有権と versioning](./abi-ownership-and-versioning.md)
  ...
  - API allowlist（M2 の 9 本 + M3.5 の `imencode` / `imdecode` + M5 の module 追加 3 本で 14 本）と、まだ作らないもの
