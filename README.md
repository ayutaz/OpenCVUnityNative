...
the package you install, and **the code path that actually moves pixels has never
run in CI.** Both CI Unity lanes run with `-nographics`, where `RenderTexture`
