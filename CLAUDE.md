...
| M6 | Web / Wasm（Unity 同梱 Emscripten と整合）。**着手する前に読むこと** —— roadmap の M6 節に「M4 / M5 の後に着手するとき、何が変わっているか」を足した（platform は 17 箇所・宣言は生成物・依存 allowlist が新しい依存を捕まえる）。**そして着手する前に配ること** |
